...
python3 utils/read_realsense_depth.py --base_repo_path bunny_real_data
...
python3 utils/fuse_touch_vision.py --root_dir 'bunny_real_data' --aligning_depths 'realsense_depths' --touch_depth 'touch_depth' --zoe_depth_path 'bunny_zoe_real_world_depth' --use_uncertainty --vision_output_dir 'vision' --fused_output_dir 'fused_output_dir' --touch_var 'touch_var'

echo "Adding depths and uncertainties to transforms.json..."
echo 
sleep 1

python3 utils/add_depth_file_path_to_transforms.py --base_repo_path 'bunny_real_data' --filename 'transforms.json' --depth_file_path_template 'fused_output_dir' --uncertainty_file_path_template 'fused_output_dir_uncertainty'
...
python3 utils/create_point_cloud_from_touches.py --root_dir 'bunny_real_data' --touch_depth_dir 'touch_depth' --touch_var_dir 'touch_var' --image_dir 'imgs' --transform_json_path 'transforms.json' --train_split 0.08
