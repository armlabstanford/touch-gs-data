...
python3 utils/read_realsense_depth.py --base_repo_path mirror_data

echo "Reading touch depths..."
echo 
sleep 1

python3 utils/read_touch_depths.py --base_repo_path mirror_data
...
python3 vision_utils/run_zoe_depth.py --root_dir mirror_data/ --img_dir imgs --output_depth_path mirrors_zoe_depth
...
python3 utils/fuse_touch_vision.py --root_dir 'mirror_data' --aligning_depths 'realsense_depths' --touch_depth 'touch_depth' --zoe_depth_path 'mirrors_zoe_depth' --use_uncertainty --vision_output_dir 'vision' --fused_output_dir 'fused_output_dir' --touch_var 'touch_var'
